...
- Données rendues publiques : désignent l’ensemble des informations que vous affichez volontairement sur Weke telles que notamment les différents évènements auxquels vous participez, les informations personnelles optionnelles complétées par vous-même et visible par les autres utilisateurs de l’application (photo, date de naissance, genre, bio).

- Données relatives à la navigation : désignent les données que nous collectons lors de votre navigation sur Weke telles que notamment la date, l’heure de la connexion et/ou navigation et l’adresse IP utilisée.  
...
Nous prenons des mesures adéquates sur le plan de la technique et de l’organisation pour interdire l’accès non autorisé ou la modification, divulgation, perte ou destruction de vos Données. Il importe que vous préservez la confidentialité de vos identifiants de façon à empêcher une utilisation illicite de votre compte. 
...
- Adressant un courriel à l’adresse suivante : yannis.bendiouis@gmail.com
